...
public class LesothoCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public LesothoCourtDocument(){
	}
	
	public LesothoCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				LesothoCitations currentCitationObj = new LesothoCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new LesothoPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			LesothoCitations citationObj = new LesothoCitations();
