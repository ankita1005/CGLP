...
public class BotswanaCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public BotswanaCourtDocument(){
	}
	
	public BotswanaCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				/*	Botswana Citation object is created for each citation found in the footer	*/
				BotswanaCitations currentCitationObj = new BotswanaCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new BotswanaPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			BotswanaCitations citationObj = new BotswanaCitations();
