...
public class UgandaCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public UgandaCourtDocument(){
	}
	
	public UgandaCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				UgandaCitations currentCitationObj = new UgandaCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new UgandaPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			UgandaCitations citationObj = new UgandaCitations();
