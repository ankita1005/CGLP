...
public class IndiaCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public IndiaCourtDocument(){
	}
	
	public IndiaCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				IndiaCitations currentCitationObj = new IndiaCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new IndiaPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			IndiaCitations citationObj = new IndiaCitations();
	...
	public List<String> extractCNSTCRTParticipants(String pdfFileContent){
		...
		if(endIndex < startIndex){
			String searchString = "supreme court of india";
