...
import courtreferences.southafrica.SouthAfricanCitations;
import courtreferences.southafrica.SouthAfricanPageContent;

public class NewZealandCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public NewZealandCourtDocument(){
	}
	
	public NewZealandCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				/*	New Zealand Citation object is created for each citation found in the footer	*/
				NewZealandCitations currentCitationObj = new NewZealandCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new NewZealandPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			NewZealandCitations citationObj = new NewZealandCitations();
	...
	public List<String> extractCNSTCRTParticipants(String pdfFileContent){
		...
		if(endIndex < startIndex){
			String searchString = "supreme court of the united states ";
