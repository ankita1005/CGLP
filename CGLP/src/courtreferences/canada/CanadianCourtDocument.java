...
public class CanadianCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public CanadianCourtDocument(){
	}
	
	public CanadianCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	/* Extracts Participants name for each Canada case document	*/
	...
	/* Extracts decision date for each Canada case document	*/
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				CanadianCitations currentCitationObj = new CanadianCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new CanadianPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			CanadianCitations citationObj = new CanadianCitations();
	...
	public List<String> extractCNSTCRTParticipants(String pdfFileContent){
		...
		if(endIndex < startIndex){
			String searchString = "supreme court of canada";
