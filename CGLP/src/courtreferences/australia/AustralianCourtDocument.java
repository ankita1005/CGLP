...
public class AustralianCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public AustralianCourtDocument(){
	}
	
	public AustralianCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				AustralianCitations currentCitationObj = new AustralianCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new AustralianPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			AustralianCitations citationObj = new AustralianCitations();
