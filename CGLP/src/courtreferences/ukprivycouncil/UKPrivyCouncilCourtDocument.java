...
public class UKPrivyCouncilCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public UKPrivyCouncilCourtDocument(){
	}
	
	public UKPrivyCouncilCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				UKPrivyCouncilCitations currentCitationObj = new UKPrivyCouncilCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new UKPrivyCouncilPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			UKPrivyCouncilCitations citationObj = new UKPrivyCouncilCitations();
