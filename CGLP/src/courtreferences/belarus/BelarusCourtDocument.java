...
public class BelarusCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public BelarusCourtDocument(){
	}
	
	public BelarusCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				BelarusCitations currentCitationObj = new BelarusCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new BelarusPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			BelarusCitations citationObj = new BelarusCitations();
