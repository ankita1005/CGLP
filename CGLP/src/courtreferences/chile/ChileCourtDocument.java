...
public class ChileCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public ChileCourtDocument(){
	}
	
	public ChileCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				ChileCitations currentCitationObj = new ChileCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new ChilePageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			ChileCitations citationObj = new ChileCitations();
