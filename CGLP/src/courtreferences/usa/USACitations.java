...
public class USACitations extends Citations{
	/*
	...
	public USACitations(String caseid, String countryName, String courtName, int pdfcitationid, String citationString, int pageNo){
