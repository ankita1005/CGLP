...
public class UKHouseofLordsCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public UKHouseofLordsCourtDocument(){
	}
	
	public UKHouseofLordsCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractParticipants(String CourtName,String pdfFileContent){
		if(CourtName.equals("High Court")){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				UKHouseofLordsCitations currentCitationObj = new UKHouseofLordsCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new UKHouseofLordsPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			UKHouseofLordsCitations citationObj = new UKHouseofLordsCitations();
	...
	public List<String> extractCNSTCRTParticipants(String pdfFileContent){
		...
		if(endIndex < startIndex){
			String searchString = "high court of australia";
