...
public class ZimbabweCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public ZimbabweCourtDocument(){
	}
	
	public ZimbabweCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				ZimbabweCitations currentCitationObj = new ZimbabweCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new ZimbabwePageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			ZimbabweCitations citationObj = new ZimbabweCitations();
