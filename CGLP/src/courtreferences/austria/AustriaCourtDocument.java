...
public class AustriaCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public AustriaCourtDocument(){
	}
	
	public AustriaCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				AustriaCitations currentCitationObj = new AustriaCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new AustriaPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			AustriaCitations citationObj = new AustriaCitations();
