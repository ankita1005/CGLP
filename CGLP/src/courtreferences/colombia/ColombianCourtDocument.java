...
public class ColombianCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public ColombianCourtDocument(){
	}
	
	public ColombianCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				ColombianCitations currentCitationObj = new ColombianCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new ColombianPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			ColombianCitations citationObj = new ColombianCitations();
