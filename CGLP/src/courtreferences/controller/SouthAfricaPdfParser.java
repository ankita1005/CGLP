...
public class SouthAfricaPdfParser extends DocumentParser {
	/* 
	...
	*/
	...
	public SouthAfricaPdfParser(){
	}
	
	
	public SouthAfricaPdfParser(String countryname,String courtname, String processedUser){
	...
	SouthAfricanCourtDocument maf = new SouthAfricanCourtDocument(this.getCountryName(),this.getCourtName(), this.getProcessedUserName(), sourceFileName);
	...
	String extractContentFromDocument(String pdfFile,int startpage,int endpage){
		...
		if( pdfFile == null ){
			...
			try{
	       	...
	       	String caseId=null,descisionDate = null,heardDate=null;
	       	 ...
	       	 for(String line:lines)
	       	 {
	       		 if(line.contains("Heard on"))
	       		 {
	       			 String[] splitIt = line.split(" ");
	       			 
	       			 heardDate = splitIt[3]+" "+splitIt[4]+" "+splitIt[5];
	       			 System.out.println(heardDate);
	       			 break;
	       		 }
	       	 ...
	       	 for(String line:lines)
	       	 {
	       		 if(line.contains("Decided on"))
	       		 {
	       			 String[] splitIt = line.split(" ");
	       			 descisionDate = splitIt[3]+" "+splitIt[4]+" "+splitIt[5];
	       			 System.out.println(descisionDate);
	       			 break;
	       		 }
