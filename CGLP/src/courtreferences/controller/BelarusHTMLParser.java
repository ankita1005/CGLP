...
public class BelarusHTMLParser extends DocumentParser {
	...
	private BelarusHTMLParser(){}
	
	public BelarusHTMLParser(String countryname,String courtname, String processedUser){
