...
public class SwitzerlandCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public SwitzerlandCourtDocument(){
	}
	
	public SwitzerlandCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				SwitzerlandCitations currentCitationObj = new SwitzerlandCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new SwitzerlandPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			SwitzerlandCitations citationObj = new SwitzerlandCitations();
