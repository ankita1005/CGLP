...
public class GermanyCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public GermanyCourtDocument(){
	}
	
	public GermanyCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				GermanyCitations currentCitationObj = new GermanyCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new GermanyPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			GermanyCitations citationObj = new GermanyCitations();
