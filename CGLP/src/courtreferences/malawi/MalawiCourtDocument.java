...
public class MalawiCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public MalawiCourtDocument(){
	}
	
	public MalawiCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				MalawiCitations currentCitationObj = new MalawiCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new MalawiPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			MalawiCitations citationObj = new MalawiCitations();
