...
public class IrelandCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public IrelandCourtDocument(){
	}
	
	public IrelandCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				/*	USA Citation object is created for each citation found in the footer	*/
				IrelandCitations currentCitationObj = new IrelandCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new IrelandPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			IrelandCitations citationObj = new IrelandCitations();
