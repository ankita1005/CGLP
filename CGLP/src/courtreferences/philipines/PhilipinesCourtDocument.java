...
public class PhilipinesCourtDocument extends CourtDocument implements ProcessCitations {
	/*
	...
	public PhilipinesCourtDocument(){
	}
	
	public PhilipinesCourtDocument(String countryName, String courtName, String processedUserName, String sourceFileName){
	...
	public void extractCNSTCRTCitations(List<String> fileContent){
		...
		for(String pageContent : fileContent){
			...
			while(true){
				...
				PhilipinesCitations currentCitationObj = new PhilipinesCitations(this.getCaseId(),this.getCountryName(),this.getCourtName(),currentCitationId,currCitationString.trim(),currentPageNo);
			...
			PageContent currentPage = new PhilipinesPageContent(currentPageNo, pageContent.toLowerCase());
	...
	public void extractCitationsFromPageBodyContent(){
		for(PageContent bodyContent : this.getDocumentPages()){
			PhilipinesCitations citationObj = new PhilipinesCitations();
